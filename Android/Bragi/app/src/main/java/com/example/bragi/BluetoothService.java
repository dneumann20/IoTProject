...
public class BluetoothService {
    ...
    class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device, UUID uuid, String address) {
        ...
        public void run(){
            ...
            try {
                ...
                e.printStackTrace();
                Log.d(TAG, "Could not connect to Socket.");
                try {
                    mmSocket.close();
    ...
    public void startClient(BluetoothDevice device,UUID uuid, String deviceAddress) throws InterruptedException {

        Log.d(TAG, "startClient: Started.");

        //initprogress dialog
        //mProgressDialog = ProgressDialog.show(mContext,"Connecting Bluetooth","Please Wait...",true);
        mConnectThread = new ConnectThread(device, uuid, deviceAddress);
